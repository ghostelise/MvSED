...
def make_word_embeddings(vocab):
    ...
    '/home/liuqt/gensim-data/glove-wiki-gigaword-200/glove-wiki-gigaword-200.gz'
)
...
class Preprocess:
    ...
    def preprocess_jsonlist(self, dataset_dir, label_name=None):
        train_items = file_utils.read_jsonlist(os.path.join(dataset_dir, 'text.jsonlist'))
        ...
        rst = self.preprocess(raw_train_texts, train_labels, None, None)
